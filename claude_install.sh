#!/bin/bash
# =============================================================================
# claude 极简安装脚本 - proot-distro Debian 终极优化版
# 架构：Standalone pnpm -> Node.js (LTS) -> claude
# =============================================================================
...
info "获取并编译 claude..."
pnpm add -g @anthropic-ai/claude-code >/dev/null 2>&1
ok "claude 安装完成"
